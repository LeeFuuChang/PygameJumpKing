...
class JumpKing:
    ...
    def __init__(self):
        ...
        self.player = Player()
        self.levels = MapLoader("assets\data\map.json").loadLevels()
    ...
    def UpdatePlayer(self, lines):
        ...
        self.player.Update(currentLines=lines)
    ...
    def run(self):
        while(True):
            ...
            self.UpdatePlayer(self.levels[self.player.currentLevelNo].lines)
